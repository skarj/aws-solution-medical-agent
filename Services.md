...
| **Amazon Bedrock (Foundation Models)** | High-accuracy LLM reasoning for rule structuring and JSON verdict enforcement (Anthropic Claude Sonnet 5 mandated for `[REQ-F-05]`, invoked via the Geographic (US) cross-Region inference profile per the 2026-08-25 `[REQ-OPS-01]` relaxation; Amazon Nova Pro / Claude 3.5 Sonnet remain valid in-Region alternatives for `[REQ-F-16]`, which has no mandated model). | `[REQ-F-05]`, `[REQ-F-16]` | [Amazon Bedrock Foundation Models Documentation](https://docs.aws.amazon.com/bedrock/latest/userguide/models-supported.html) |
