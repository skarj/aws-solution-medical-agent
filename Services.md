...
| **Amazon Bedrock (Agents)** | Single-agent deterministic reasoning engine, powered by Anthropic Claude Sonnet 5 (mandated by `[REQ-F-14]`, 2026-08-25), pulling protocol criteria and evaluating patient records via RAG. Invoked via the Geographic (US) cross-Region inference profile `us.anthropic.claude-sonnet-5` per the `[REQ-OPS-01]` relaxation. | `[REQ-F-14]`, `[REQ-F-15]`, `[REQ-F-16]` | [Amazon Bedrock Agents Documentation](https://docs.aws.amazon.com/bedrock/latest/userguide/agents.html) |
...
| **Amazon Bedrock (Foundation Models)** | High-accuracy LLM reasoning for rule structuring (`[REQ-F-05]`) and agentic verdict generation (`[REQ-F-14]`) — both now mandate Anthropic Claude Sonnet 5, invoked via the Geographic (US) cross-Region inference profile per the 2026-08-25 `[REQ-OPS-01]` relaxation. | `[REQ-F-05]`, `[REQ-F-14]`, `[REQ-F-16]` | [Amazon Bedrock Foundation Models Documentation](https://docs.aws.amazon.com/bedrock/latest/userguide/models-supported.html) |
