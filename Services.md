...
| **AWS Lambda** | Event-driven microservices for rule parsing, the explicit patient-screening trigger handler (`screening-trigger-handler`), patient full-text document consolidation (`patient-text-consolidator`), the full-document reasoning invocation handler (`patient-screening-handler`), API handlers, and Bedrock Agent actions. | `[REQ-F-05]`, `[REQ-F-07]`, `[REQ-F-08]`, `[REQ-F-11]`, `[REQ-F-14]`, `[REQ-F-15]`, `[REQ-SEC-04]` | [AWS Lambda Documentation](https://docs.aws.amazon.com/lambda/) |
